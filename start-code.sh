...
img_output="deepexi/demo"      # output image tag
...
sudo mv $proj_home/demo-provider/target/demo-*.jar $proj_home/demo-provider/target/demo.jar # 兼容所有sh脚本
